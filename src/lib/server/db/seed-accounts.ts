...
type SeedAccount = { code: number; name: string; type: AccountTypeCode };
...
export const DEFAULT_CHART: readonly SeedAccount[] = [
  ...
  { code: 4100, name: "Other Revenue", type: AccountType.Revenue },
  { code: 5000, name: "Cost of Goods Sold", type: AccountType.Expense },
  { code: 5100, name: "Advertising", type: AccountType.Expense },
  { code: 5200, name: "Packaging", type: AccountType.Expense },
  { code: 5300, name: "Shipping", type: AccountType.Expense },
  { code: 5400, name: "Software", type: AccountType.Expense },
  { code: 5500, name: "Utilities", type: AccountType.Expense },
